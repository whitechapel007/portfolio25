          ...
          <div class="mb-16">
            ...
            <div class="space-y-12">
              ...
              >
                <!-- Timeline line -->
                <div
                  class="absolute top-0 left-0 h-full w-0.5 bg-primary-200 dark:bg-primary-900"
                ></div>

                <!-- Timeline dot -->
                <div
                  class="absolute top-0 left-0 w-5 h-5 -ml-2.5 rounded-full bg-primary-600"
                ></div>
          ...
          <div>
            ...
            <div class="space-y-12">
              ...
              >
                <!-- Timeline line -->
                <div
                  class="absolute top-0 left-0 h-full w-0.5 bg-secondary-200 dark:bg-secondary-900"
                ></div>

                <!-- Timeline dot -->
                <div
                  class="absolute top-0 left-0 w-5 h-5 -ml-2.5 rounded-full bg-secondary-600"
                ></div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                  <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4">
                    ...
                    <div class="mt-2 sm:mt-0">
                      <span
                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-secondary-100 text-secondary-800 dark:bg-secondary-900 dark:text-secondary-200"
                      >
                        {{ edu.period }}
                      </span>
                    </div>
